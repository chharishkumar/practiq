      ...
      <span>
        Return ONLY these columns. Additional columns will be marked incorrect.
          ...
          <div style={{ background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: "8px", padding: "0.625rem 0.75rem", marginBottom: "0.875rem" }}>
            ...
            <p style={{ margin: 0, fontSize: "0.78rem", color: "#1e40af", lineHeight: 1.6 }}>{p.interview}</p>
          </div>
          <div style={{ marginBottom: "0.875rem" }}>
...
export default function SQLInterviewPage() {
  ...
  usePageMeta({
    ...
    description: selectedProblem
      ...
      : "Practice SQL Interview interview questions.",
                ...
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
                  <div>
                    <div style={{ display: "flex", gap: "8px", alignItems: "center", marginBottom: "6px" }}>
                      <span style={{ fontSize: "0.7rem", padding: "3px 10px", borderRadius: "10px", background: "#f0fdf4", color: "#16a34a", border: "1px solid #bbf7d0", fontWeight: 600 }}>Interview</span>
