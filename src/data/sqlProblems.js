export const SQL_PROBLEMS = [
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find all customers created after 2023-03-01.",
      ...
      expectedRowCount: 3,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE created_date > '2023-03-01';",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Return all customers sorted by created_date in descending order.",
      ...
      hint: "Use ORDER BY created_date DESC",
      starterQuery: "SELECT * FROM customers LIMIT 5;",
      expectedColumns: [
        "customer_id",
        "customer_name",
      ...
      expectedRowCount: 5,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers ORDER BY created_date DESC LIMIT 5;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Return the total number of customers in the customers table.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return only the first 3 customers from the customers table.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find verified customers from India.",
      ...
      expectedRowCount: 2,
      solutionQuery: "SELECT customer_id, customer_name, country, is_verified FROM customers WHERE country = 'India' AND is_verified = true;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers located in either India or USA.",
      ...
      hint: "Use OR between country conditions",
      starterQuery: "SELECT * FROM customers LIMIT 5;",
      expectedColumns: [
        "customer_id",
        "customer_name",
      ...
      expectedRowCount: 5,
      solutionQuery: "SELECT customer_id, customer_name, country FROM customers WHERE country = 'India' OR country = 'USA';",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find orders with order_status as 'Delivered', 'Cancelled', or 'Pending'.",
      ...
      hint: "Use WHERE order_status IN (...)",
      ...
      expectedRowCount: 5,
      solutionQuery: "SELECT order_id, customer_id, order_status FROM orders WHERE order_status IN ('Delivered', 'Cancelled', 'Pending');",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return all orders where total_amount is not NULL.",
      ...
      hint: "Use WHERE total_amount IS NOT NULL",
      ...
      expectedRowCount: 5,
      solutionQuery: "SELECT * FROM orders WHERE total_amount IS NOT NULL;",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find all orders with total_amount between 150 and 300.",
      ...
      hint: "Use BETWEEN 150 AND 300",
      starterQuery: "SELECT * FROM orders WHERE total_amount BETWEEN 150 AND 300;",
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 3,
      solutionQuery: "SELECT * FROM orders WHERE total_amount BETWEEN 150 AND 300;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Return all customers except customer_id 1 and 2.",
      ...
      expectedRowCount: 3,
      solutionQuery: "SELECT * FROM customers WHERE customer_id NOT IN (1, 2);",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return all orders above 200 sorted by highest total_amount first.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return all orders placed in January 2024.",
    ...
    
    {
      ...
      hint: "Use LEFT JOIN with COALESCE(SUM(total_amount),0)",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find all products priced at 100 or more.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return all products sorted from lowest price to highest price.",
      ...
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 5,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products ORDER BY price ASC;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find all products whose product_name contains the word 'Pro'.",
      ...
      hint: "Use LIKE '%Pro%'",
      starterQuery: "SELECT * FROM products WHERE product_name LIKE '%Pro%';",
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 2,
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find products in either the 'Electronics' or 'Accessories' category.",
      ...
      starterQuery: "SELECT * FROM products WHERE category = 'Electronics' OR category = 'Accessories';",
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 3,
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find the customer record for 'David Brown'.",
      ...
      expectedRowCount: 1,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE customer_name = 'David Brown';",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find all orders where total_amount is less than 200.",
      ...
      hint: "Use WHERE total_amount < 200",
      starterQuery: "SELECT * FROM orders WHERE total_amount < 200;",
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 2,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE total_amount < 200;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Return the total sum of all product prices.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return customers where email is NULL.",
    ...
    
    {
      ...
      hint: "Use COUNT(*) with order_date filter",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return customer names sorted alphabetically from A to Z.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find orders with order_id 1, 3, or 5.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return products priced exactly at 29, 99, or 199.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers whose name contains 'son'.",
      ...
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 2,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE customer_name LIKE '%son%';",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Sort products by category ascending and price descending.",
      ...
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 5,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products ORDER BY category ASC, price DESC;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Return all orders placed on '2024-01-25'.",
      ...
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 1,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE order_date = '2024-01-25';",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers whose name starts with 'Alice'.",
      ...
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 1,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE customer_name LIKE 'Alice%';",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find orders where total_amount is greater than 262.",
      ...
      hint: "Use WHERE total_amount > 262",
      starterQuery: "SELECT * FROM orders WHERE total_amount > 262;",
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 2,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE total_amount > 262;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers whose email does not end with '@email.com'.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return all orders placed in 2024.",
      ...
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 5,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE order_date LIKE '2024%';",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers where email is an empty string.",
    ...
    },
    {
      ...
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 1,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE email LIKE '%john%';",
    },
    
    {
      ...
      hint: "Use SUM(total_amount) with order_date filter",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return all products sorted by category from Z to A.",
      ...
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 5,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products ORDER BY category DESC;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find products where category is NULL.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Return the 2 most expensive products.",
      ...
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 2,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products ORDER BY price DESC LIMIT 2;",
    },
    
    {
      ...
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 2,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE customer_name IN ('Alice Johnson', 'Charlie Davis');",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find orders with total_amount between 50 and 150.",
      ...
      hint: "Use BETWEEN 50 AND 150",
      starterQuery: "SELECT * FROM orders WHERE total_amount BETWEEN 50 AND 150;",
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 1,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE total_amount BETWEEN 50 AND 150;",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers whose customer_name length is greater than 12.",
      ...
      hint: "Use LENGTH(customer_name) > 12",
      starterQuery: "SELECT * FROM customers WHERE LENGTH(customer_name) > 12;",
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 4,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE LENGTH(customer_name) > 12;",
    },
    {
      id: 81,
      title: "Exclude a product category",
      difficulty: "Easy",
      description: "Return all products that are not in the 'Electronics' category.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find products where the product_name has 10 or fewer characters.",
      ...
      hint: "Use LENGTH(product_name) <= 10",
      starterQuery: "SELECT * FROM products WHERE LENGTH(product_name) <= 10;",
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 2,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products WHERE LENGTH(product_name) <= 10;",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find orders where total_amount has no decimal values.",
      ...
      hint: "Use total_amount % 1 = 0",
      starterQuery: "SELECT * FROM orders WHERE total_amount % 1 = 0;",
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 5,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE total_amount % 1 = 0;",
    },
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers whose names end with the letter 'y'.",
    ...
    
    {
      ...
      difficulty: "Easy",
      description: "Find products where category contains 'Service'.",
      ...
      hint: "Use category LIKE '%Service%'",
      starterQuery: "SELECT * FROM products WHERE category LIKE '%Service%';",
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 2,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products WHERE category LIKE '%Service%';",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find orders where total_amount is above 300 or below 50.",
      ...
      hint: "Use total_amount > 300 OR total_amount < 50",
      starterQuery: "SELECT * FROM orders WHERE total_amount > 300 OR total_amount < 50;",
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 1,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders WHERE total_amount > 300 OR total_amount < 50;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Sort orders by order_date ascending and total_amount descending.",
      explanation: "Multiple ORDER BY columns organize data more precisely.",
      scenario: "Finance teams want largest orders first within each day.",
      useCases: [
        "Daily reporting",
        "Sales analysis",
        "Order tracking"
      ...
      expectedColumns: ["order_id", "customer_id", "order_date", "total_amount"],
      expectedRowCount: 5,
      solutionQuery: "SELECT order_id, customer_id, order_date, total_amount FROM orders ORDER BY order_date ASC, total_amount DESC;",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Find customers using Gmail email addresses.",
      explanation: "LIKE can identify email domains.",
      scenario: "Marketing teams target Gmail users for campaigns.",
      useCases: [
        "Customer segmentation",
        "Email analysis",
        "Marketing filters"
      ...
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 0,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE email LIKE '%gmail.com%';",
    },
    
    {
      id: 94,
      title: "Count products in Accessories category",
      difficulty: "Easy",
      description: "Count how many products belong to the 'Accessories' category.",
      explanation: "COUNT(*) counts filtered rows.",
      scenario: "Inventory managers monitor category sizes.",
      useCases: [
        "Category analysis",
        "Inventory KPIs",
        "Catalog reporting"
      ],
      hint: "Use COUNT(*) with WHERE category = 'Accessories'",
      starterQuery: "SELECT COUNT(*) AS accessories_count FROM products WHERE category = 'Accessories';",
      expectedColumns: ["accessories_count"],
      expectedRowCount: 1,
      solutionQuery: "SELECT COUNT(*) AS accessories_count FROM products WHERE category = 'Accessories';",
    },
    
    {
      ...
      difficulty: "Easy",
      description: "Return the product where product_id equals 1.",
      explanation: "Equality filters retrieve exact rows.",
      scenario: "Customer support needs product details quickly.",
      useCases: [
        "Product lookup",
        "Inventory checks",
        "Troubleshooting"
      ],
      hint: "Use WHERE product_id = 1",
      starterQuery: "SELECT * FROM products WHERE product_id = 1;",
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 1,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products WHERE product_id = 1;",
    },
    
    {
      id: 96,
      title: "Calculate tax-exclusive prices",
      difficulty: "Easy",
      description: "Assuming prices include 10% tax, calculate the base price.",
      explanation: "Division can reverse tax calculations.",
      scenario: "Finance teams need pre-tax revenue values.",
      useCases: [
        "Tax reporting",
        "Accounting",
        "Financial analysis"
      ...
      expectedRowCount: 5,
      solutionQuery: "SELECT product_name, price / 1.1 AS base_price FROM products;",
    },
    
    {
      id: 97,
      title: "Sort product names reverse alphabetically",
      difficulty: "Easy",
      description: "Sort products by product_name from Z to A.",
      explanation: "DESC works on text columns as well.",
      scenario: "Catalog teams review products from the end of the alphabet.",
      useCases: [
        "Catalog organization",
        "Sorting",
        "Inventory review"
      ],
      hint: "Use ORDER BY product_name DESC",
      starterQuery: "SELECT * FROM products ORDER BY product_name DESC;",
      expectedColumns: ["product_id", "product_name", "category", "price"],
      expectedRowCount: 5,
      solutionQuery: "SELECT product_id, product_name, category, price FROM products ORDER BY product_name DESC;",
    },
    
    {
      id: 98,
      title: "Count reachable customers",
      difficulty: "Easy",
      description: "Count customers with a non-null email address.",
      explanation: "COUNT(column) ignores NULL values.",
      scenario: "Marketing teams need reachable customer counts.",
      useCases: [
        "Lead analysis",
        "CRM reporting",
        "Email campaigns"
      ...
      expectedRowCount: 1,
      solutionQuery: "SELECT COUNT(email) AS reachable_customers FROM customers;",
    },
    
    {
      id: 99,
      title: "Find customers starting with Charlie",
      difficulty: "Easy",
      description: "Find customers whose name starts with 'Charlie'.",
      explanation: "LIKE with trailing wildcard performs prefix searches.",
      scenario: "Support teams search by first name only.",
      useCases: [
        "Customer lookup",
        "CRM searches",
        "Pattern matching"
      ],
      hint: "Use LIKE 'Charlie%'",
      starterQuery: "SELECT * FROM customers WHERE customer_name LIKE 'Charlie%';",
      expectedColumns: ["customer_id", "customer_name", "email", "created_date"],
      expectedRowCount: 1,
      solutionQuery: "SELECT customer_id, customer_name, email, created_date FROM customers WHERE customer_name LIKE 'Charlie%';",
    },
    
    {
      id: 100,
      title: "Generate overall sales summary",
      difficulty: "Easy",
      description: "Return total revenue, average order value, and highest order value.",
      explanation: "Multiple aggregate functions can be combined in one query.",
      scenario: "Executives want a quick business performance summary.",
      useCases: [
        "Executive dashboards",
        "KPI reporting",
        "Business summaries"
      ],
      hint: "Use SUM(), AVG(), and MAX()",
      starterQuery: "SELECT SUM(total_amount) AS total_revenue, AVG(total_amount) AS avg_order_value, MAX(total_amount) AS highest_order_value FROM orders;",
      expectedColumns: ["total_revenue", "avg_order_value", "highest_order_value"],
      expectedRowCount: 1,
      solutionQuery: "SELECT SUM(total_amount) AS total_revenue, AVG(total_amount) AS avg_order_value, MAX(total_amount) AS highest_order_value FROM orders;",
    },
  ];