...
export default function SQLBasicsPage() {
  ...
  const handleSelectProblem = useCallback((p) => {
    ...
    setError(null);
    setValidationStatus(null);
    navigate(`/sql/advanced/${p.id}`); // ADD THIS LINE
  ...
  useEffect(() => {
    ...
    if (incoming.focusProblemId !== undefined) {
      ...
      const targetProblem = SQL_ADVANCED_PROBLEMS.find(
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
          ...
          >
            ✓ {solvedIds.size} / {SQL_ADVANCED_PROBLEMS.length} solved
          </div>
          <span
            ...
            >
              <div style={{ textAlign: "center", maxWidth: "360px" }}>
                ...
                >
                  ...
                  all {SQL_ADVANCED_PROBLEMS.length} SQL problems and save your progress.
                </p>
                <button
