...
export default function SQLBasicsPage() {
  ...
  console.log("isGuest:", isGuest); // ADD THIS
  ...
  const handleSelectProblem = useCallback((p) => {
    ...
    setError(null);
    setValidationStatus(null);
    navigate(`/sql/interview/${p.id}`); // ADD THIS LINE
  ...
  useEffect(() => {
    ...
    if (incoming.focusProblemId !== undefined) {
      ...
      const targetProblem = SQL_INTERVIEW_PROBLEMS.find(
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
          ...
          >
            ✓ {solvedIds.size} / {SQL_INTERVIEW_PROBLEMS.length} solved
          </div>
          <span
            ...
            >
              <div style={{ textAlign: "center", maxWidth: "360px" }}>
                ...
                >
                  ...
                  all {SQL_INTERVIEW_PROBLEMS.length} SQL problems and save your progress.
                </p>
                <button
